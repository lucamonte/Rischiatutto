...
//CONTROLLO LE RISPOSTE
        ...
        function valutaCartoni3000(n){
            ...
            if (n == soluzioneCartoni3000[oldindice]) {
                ...
                document.getElementById("cartoni3").style.fontSize = "185%";
                document.getElementById("cartoni3").innerHTML = "Rischio";
                }
...
function startRischiaCartoni3000() { //Funzione associata al bottone con id "smartphone5" sul tabellone
                ...
                document.getElementById("bottone-rischia").onclick = function() {RischiaCartoni3000()};
                ...
                function RischiaCartoni3000() { //Funzione associata al bottone con id "bottone-rischia"
                ...
                if (rischio>=3000 && rischio<=montepremi) { //Controllo se la cifra inserita è valida
                    inizioCartoni3000(); //Se è valida, genero la domanda
                    clearInterval(id);
                    moveCartoni3000();
                }
                else
...
//JOLLY
    ...
    function jollyCartoni3000(){
        ...
        document.getElementById("cartoni3").disabled = true;
        document.getElementById("cartoni3").style.backgroundColor = "#ffaa00";
        document.getElementById("cartoni3").style.color = "white";
