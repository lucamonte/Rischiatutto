...
//CONTROLLO LE RISPOSTE
        ...
        function valutaCalcio3000(n){
            ...
            if (n == soluzioneCalcio3000[oldindice]) {
                ...
                document.getElementById("calcio3").style.fontSize = "185%";
                document.getElementById("calcio3").innerHTML = "Rischio";
                }
...
function startRischiaCalcio3000() { //Funzione associata al bottone con id "smartphone5" sul tabellone
                ...
                document.getElementById("bottone-rischia").onclick = function() {RischiaCalcio3000()};
                ...
                function RischiaCalcio3000() { //Funzione associata al bottone con id "bottone-rischia"
                ...
                if (rischio>=3000 && rischio<=montepremi) { //Controllo se la cifra inserita è valida
                    inizioCalcio3000(); //Se è valida, genero la domanda
                    clearInterval(id);
                    moveCalcio3000();
                }
                else
...
//JOLLY
    ...
    function jollyCalcio3000(){
        ...
        document.getElementById("calcio3").disabled = true;
        document.getElementById("calcio3").style.backgroundColor = "#ffaa00";
        document.getElementById("calcio3").style.color = "white";
