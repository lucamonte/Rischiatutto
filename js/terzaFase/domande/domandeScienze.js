var Domanda = ["Da dove proveniva Niccolò Copernico?",																		//21
			   "In quale materia venne bocciato Einstein?",																	//22
			   "Dove nacque Einstein?",																						//23
		       "Da quale scienziato fu scoperta la gravità?",																//24
			   "Chi inventò la pila?",																						//25
		       "Da cosa sono costituite le molecole?",																		//26
			   "Come si chiama il ramo della chimica che si occupa dello sviluppo sostenibile?",							//27
			   "Dov'è situato il Cern?",																					//28
		       "Chi ha pronunciato la seguente frase: 'Nulla si crea, nulla si distrugge, tutto si trasforma'?",					//29
			   "Quale ramo della chimica è il più antico?"];  															//30

var Soluzione = ["polonia",
				 "matematica",
				 "ulma",
				 "newton",
				 "volta",
